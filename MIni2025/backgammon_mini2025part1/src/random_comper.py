...
class CompareAllMoves_random(Strategy):
    ...
    def move(self, board, colour, dice_roll, make_move, opponents_activity):
        ...
        move_scores = [(result['best_value'], result['best_moves'])]
        if not_a_double:
            move_scores.append((result_swapped['best_value'], result_swapped['best_moves']))
...
class CompareAllMovesSimple_random(CompareAllMoves_random):
...
class CompareAllMovesWeightingDistance_random(CompareAllMoves_random):
...
class CompareAllMovesWeightingDistanceAndSingles_random(CompareAllMoves_random):
...
class CompareAllMovesWeightingDistanceAndSinglesWithEndGame_random(CompareAllMoves_random):
...
class CompareAllMovesWeightingDistanceAndSinglesWithEndGame2_random(CompareAllMoves_random):
